...
const abuotSection = [
    {
        ...
        description:"Je suis spécialisé dans la création d'interfaces utilisateur attrayantes et fonctionnelles ",
    ...
    
    {
        ...
        description:"Je m'efforce de concevoir des expériences utilisateur intuitives et engageantes.",
